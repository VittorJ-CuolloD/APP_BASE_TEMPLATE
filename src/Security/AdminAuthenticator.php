...
class AdminAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException('El email no existe.');
        }

        if(!$user->getActive()){
            throw new CustomUserMessageAuthenticationException('Se ha deshabilitado el acceso a esta cuenta.');
        }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey)
    {
        ...
        $this->session->set('_locale', $this->session->get('_locale') ?? 'es');
